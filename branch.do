...
# vsim -gui work.processorfinal 
# Start time: 20:19:45 on May 18,2024
...
# This port will contribute value (U) to the signal network.
mem load -i {D:/gam3a/spring 2024/CMPN301 Computer Architecture/my project/Computer-Architecture-Project/Branch.mem} /processorfinal/FetchStage/IM1/ram
...
force -freeze sim:/processorfinal/InPort 00000000000000000000000000110000 0
run
force -freeze sim:/processorfinal/InPort 00000000000000000000000001010000 0
run
force -freeze sim:/processorfinal/InPort 00000000000000000000000100000000 0
run
force -freeze sim:/processorfinal/InPort 00000000000000000000001100000000 0
run
run
run
run
run
# ** Warning: NUMERIC_STD.TO_INTEGER: metavalue detected, returning 0
#    Time: 850 ps  Iteration: 3  Instance: /processorfinal/DecodeStage/RegFile1
# ** Warning: NUMERIC_STD.TO_INTEGER: metavalue detected, returning 0
#    Time: 850 ps  Iteration: 3  Instance: /processorfinal/DecodeStage/RegFile1
run
force -freeze sim:/processorfinal/InPort 00000000000000000000001100000000 0
run
# ** Warning: NUMERIC_STD.TO_INTEGER: metavalue detected, returning 0
#    Time: 1100 ps  Iteration: 1  Instance: /processorfinal/DecodeStage/RegFile1
# ** Warning: NUMERIC_STD.TO_INTEGER: metavalue detected, returning 0
#    Time: 1100 ps  Iteration: 1  Instance: /processorfinal/DecodeStage/RegFile1
run
run
run
force -freeze sim:/processorfinal/InPort 00000000000000000000000001100000 0
run
run
run
force -freeze sim:/processorfinal/InPort 00000000000000000000000001110000 0
run
run
run
run
...
run
run
force -freeze sim:/processorfinal/InPort 00000000000000000000011100000000 0
run
run
run
run
...
run
# ** Warning: NUMERIC_STD.TO_INTEGER: metavalue detected, returning 0
#    Time: 3650 ps  Iteration: 3  Instance: /processorfinal/DecodeStage/RegFile1
# ** Warning: NUMERIC_STD.TO_INTEGER: metavalue detected, returning 0
#    Time: 3650 ps  Iteration: 3  Instance: /processorfinal/DecodeStage/RegFile1
run
run
# ** Warning: NUMERIC_STD.TO_INTEGER: metavalue detected, returning 0
#    Time: 3900 ps  Iteration: 1  Instance: /processorfinal/DecodeStage/RegFile1
# ** Warning: NUMERIC_STD.TO_INTEGER: metavalue detected, returning 0
#    Time: 3900 ps  Iteration: 1  Instance: /processorfinal/DecodeStage/RegFile1
run
run
